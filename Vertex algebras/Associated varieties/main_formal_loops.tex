...
\begin{document}
    ...
    \input{Vertex algebras/Associated varieties/local_loop_spaces}

    \input{Vertex algebras/Associated varieties/enveloping_algebras}

    \input{Vertex algebras/Associated varieties/poisson_VOAs_and_associated_varieties}
